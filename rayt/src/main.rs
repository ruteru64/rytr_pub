...
impl CornelBoxScene {
    fn new(i:f64) -> Self {
        ...
        world.push(ShapeBuilder::new()
            .color_texture(white)
            .lambertian()
            .box3d(Point3::new(120.0,120.0,120.0), Point3::new(165.0+120.0, 165.0+120.0, 165.0+120.0))
            .rotate(Vec3::yaxis(), 15.0+44.0-i)
            .rotate(Vec3::xaxis(),i)
            .rotate(Vec3::zaxis(),i)
            .build());
        */
        ...
        */
        for n in 0 .. 10 {
            let temp = n;
            let temp1 = temp as f64;
            if temp%7 >= 5 {
                world.push(ShapeBuilder::new()
                    .color_texture(Color::new(Float3::random_limit(0.0,255.0).x(),Float3::random_limit(0.0,255.0).y(),Float3::random_limit(0.0,255.0).z()))
                    .lambertian()
                    .sphere(Point3::new(Float3::random_limit(0.0,500.0).z(),Float3::random_limit(0.0,500.0).y(),Float3::random_limit(0.0,500.0).z()), 70.0)
                    .build());
            }else if temp%7 == 0{
                let temp_p = Point3::new(Float3::random_limit(0.0,500.0).x(),Float3::random_limit(0.0,500.0).y(),Float3::random_limit(0.0,500.0).z());
                world.push(ShapeBuilder::new()
                    .dielectric(1.5)
                    .sphere(temp_p, 70.0)
                    .build());
                ...
                world.push(ShapeBuilder::new()
                    .color_texture(Color::new(Float3::random_limit(0.0,255.0).x(),Float3::random_limit(0.0,255.0).y(),Float3::random_limit(0.0,255.0).z()))
                    .metal(0.4)
                    .sphere(Point3::new(Float3::random_limit(0.0,500.0).x(),Float3::random_limit(0.0,500.0).y(),Float3::random_limit(0.0,500.0).z()), 70.0)
                    .build());
            }
        }
