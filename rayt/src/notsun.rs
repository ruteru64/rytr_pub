        ...
        for i in 0..laxial.len(){
            ...
            if mn == 0 && sn == 0{
                world.push(ShapeBuilder::new()
                    .color_texture(Color::new(arg[0],arg[1], arg[2]))
                    .metal(arg[7])
                ...
                world.push(ShapeBuilder::new()
                    .color_texture(Color::new(arg[0],arg[1], arg[2]))
                    .metal(arg[8])
                    .rect_xy(arg[3], arg[4], arg[5], arg[6],arg[7])
                    .build());
            }else if mn == 1 && sn == 1{
                world.push(ShapeBuilder::new()
                    .color_texture(Color::new(arg[0],arg[1], arg[2]))
                ...
                world.push(ShapeBuilder::new()
                    .color_texture(Color::new(arg[0],arg[1], arg[2]))
                    .metal(arg[8])
                    .rect_xz(arg[3], arg[4], arg[5], arg[6],arg[7])
                    .build());
            }else if mn == 1 && sn == 2{
                world.push(ShapeBuilder::new()
                    .color_texture(Color::new(arg[0],arg[1], arg[2]))
                ...
                world.push(ShapeBuilder::new()
                    .color_texture(Color::new(arg[0],arg[1], arg[2]))
                    .metal(arg[8])
                    .rect_yz(arg[3], arg[4], arg[5], arg[6],arg[7])
                    .build());
            }else if mn == 1 && sn == 3{
                world.push(ShapeBuilder::new()
                    .color_texture(Color::new(arg[0],arg[1], arg[2]))
                ...
                world.push(ShapeBuilder::new()
                    .color_texture(Color::new(arg[0],arg[1], arg[2]))
                    .metal(arg[9])
                    .box3d(Point3::new(arg[3], arg[4], arg[5]), Point3::new(arg[6], arg[7], arg[8]))
                    .build());
            }else if mn == 1 && sn == 4{
                world.push(ShapeBuilder::new()
                    .color_texture(Color::new(arg[0],arg[1], arg[2]))
